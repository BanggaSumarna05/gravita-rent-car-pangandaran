      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <a
            ...
            className="flex items-center gap-2 bg-zinc-950 text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-amber-500 transition-all shadow-lg hover:shadow-amber-500/20"
          >
            <Phone size={16} />
            Hubungi Kami
          </a>
